			...
			<div class="ui container grid">
				<div class="row">
					<div class="fifteen wide computer sixteen wide phone centered column">
						<h2><i class="money bill alternate outline icon"></i> PENGELOLAAN ANGGARAN</h2>
								    	...
								    	<tr>
								    	    ...
								    	    <td style="text-align: center;">
								    	    	<div class="ui buttons">
								    	    	  ...
								    	    	  <a href="detail_periode_anggaran.php?data=<?php echo $data['id_periode']; ?>" class="ui blue button"><i class="list icon"></i> Data Anggaran</a>
								    	    	</div>
								    	    </td>
								    	</tr>
									    <?php } ?>
